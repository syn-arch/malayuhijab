            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
                        <?php if ($access['c']): ?>
                            <a href="<?php echo base_url('service/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        <?php endif ?>
                ...
                $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
                {
                 ...
                 if (up == '1' && del == '1') {
                        var t = $(".dt").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "service/json", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id_service",
                                        "orderable": false
                                    ...
                                    {"data": "nama_service"},{"data": "deskripsi"},{"data": "gambar"},
                                    {
                                        "data" : "action",
                                        "orderable": false,
                                        "className" : "text-center"
