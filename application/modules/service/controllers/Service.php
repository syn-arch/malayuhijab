...
$this->db->delete('service', ['id_service' => $id]);
		...
		'gambar' => _upload('gambar', 'service/create', 'service'),
	    );
...
$this->load->view('templates/header', $data);
		...
		'deskripsi' => $this->input->post('deskripsi',TRUE),
                                    ...
                                    if($_FILES['gambar']['name']) {
                                        $data['gambar'] = _upload('gambar', 'service/update/' . $id, 'service');
                                        delImage('service', $id, 'gambar');
                                    }
...
/* End of file Service.php */
                        /* Location: ./application/modules/C:\xampp\htdocs\malayuhijab\application/modules//controllers/Service.php */
                        /* Please DO NOT modify this information : */
                        /* Generated by Harviacode Codeigniter CRUD Generator 2022-07-18 17:07:23 */
                        /* http://harviacode.com */