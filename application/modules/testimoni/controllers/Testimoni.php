...
$this->db->delete('testimoni', ['id_testimoni' => $id]);
		...
		'gambar' => _upload('gambar', 'testimoni/create', 'testimoni'),
	    );
...
$this->load->view('templates/header', $data);
		...
		'deskripsi' => $this->input->post('deskripsi',TRUE),
                                    ...
                                    $id = $this->input->post('id_testimoni', TRUE);
                                    if($_FILES['gambar']['name']) {
                                        $data['gambar'] = _upload('gambar', 'testimoni/update/' . $id, 'testimoni');
                                        delImage('testimoni', $id, 'gambar');
                                    }
...
/* End of file Testimoni.php */
                        /* Location: ./application/modules/C:\xampp\htdocs\malayuhijab\application/modules//controllers/Testimoni.php */
