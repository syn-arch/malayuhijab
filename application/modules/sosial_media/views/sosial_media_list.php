            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
                        <?php if ($access['c']): ?>
                            <a href="<?php echo base_url('sosial_media/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        <?php endif ?>
                ...
                $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
                {
                 ...
                 if (up == '1' && del == '1') {
                        var t = $(".dt").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "sosial_media/json", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id_sosial_media",
                                        "orderable": false
                                    },
                                    {
                                        "data" : "hapus_bulk",
                                    ...
                                    {"data": "nama_sosial_media"},{"data": "link"},{"data": "gambar"},
                                    {
                                        "data" : "action",
                                        "orderable": false,
                                        "className" : "text-center"
