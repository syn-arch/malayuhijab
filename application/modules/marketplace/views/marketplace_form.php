<div class="row">
    <div class="col-xs-12">
	    ...
	    <div class="form-group <?php if(form_error('link_marketplace')) echo 'has-error'?> ">
                                                <label for="link_marketplace">Link Marketplace</label>
                                                <input type="text" class="form-control" name="link_marketplace" id="link_marketplace" placeholder="Link Marketplace" value="<?php echo $link_marketplace; ?>" />
                                                <?php echo form_error('link_marketplace', '<small style="color:red">','</small>') ?>
                                            </div>
