            ...
            <div class="box-header with-border">
                ...
                <div class="pull-right">
                    <div class="box-title">
                        ...
                        <?php endif ?>
                        <?php if ($access['c']): ?>
                            <a href="<?php echo base_url('marketplace/create') ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                        <?php endif ?>
                ...
                $.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
                {
                 ...
                 if (up == '1' && del == '1') {
                        var t = $(".dt").dataTable({
                                ...
                                processing: true,
                                serverSide: true,
                                ajax: {"url": "marketplace/json", "type": "POST"},
                                columns: [
                                    {
                                        "data": "id_marketplace",
                                        "orderable": false
                                    ...
                                    {"data": "nama_marketplace"},{"data": "deskripsi"},{
                                        "data": "gambar",
                                        "render" : function (data, type, row, meta) {
                                            return '<img src="<?php echo base_url('assets/img/marketplace/') ?>'+data+'" width="100">';
                                        }
