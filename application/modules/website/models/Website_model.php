...
class Website_model extends CI_Model
{
    ...
    // datatables
        function json() {
            ...
            $this->datatables->select('id_website,nama_website,deskripsi,deskripsi_service,deskripsi_testimoni,gambar_tentang,gambar_kontak');
...
$this->datatables->add_column('action', 
                ...
                <a data-href="'  . site_url('website/delete/$1') . '" class="btn btn-danger hapus-data"><i class="fa fa-trash"></i></a>', 'id_website');
            }else if( $access['u'] == '1'){
                 
$this->datatables->add_column('action', 
                '<a href="'  . site_url('website/read/$1') . '" class="btn btn-info"><i class="fa fa-eye"></i></a> 
                <a href="'  . site_url('website/update/$1') . '" class="btn btn-warning"><i class="fa fa-edit"></i></a>', 'id_website');
            } else if($access['d'] == '1'){
...
$this->datatables->add_column('action', '<a href="'  . site_url('website/read/$1') . '" class="btn btn-info"><i class="fa fa-eye"></i></a>','id_website');
            ...
            if ($access['d'] == '1') {
                ...
                '<input type="checkbox" class="data_checkbox" name="data[]" value="$1">', 'id_website');
            }else{
