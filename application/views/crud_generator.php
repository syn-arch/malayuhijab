            ...
            <div class="box-body">
                <div class="row">
                    <div class="col-md-3">
                        <form method="POST" class="form-crud">
                            ...
                            <div class="form-group kolom_gambar" style="<?php echo isset($_POST['ada_gambar']) ? 'display: block' : 'display: none'; ?>">
                                <label>Kolom Gambar</label>
                                <input type="text" id="kolom_gambar" name="kolom_gambar" value="<?php echo isset($_POST['kolom_gambar']) ? $_POST['kolom_gambar'] : '' ?>" class="form-control" placeholder="Kolom gambar" />
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        <ol>
                            <li>Primary key pada tabel harus bertipe integer, auto increment dan diawali dengan id_tabel (contoh : id_kontak)</li>
                            <li>Pastikan url menu pada pengelola menu bersifat unik</li>
                            <li>Ketika menggunakan join, pastikan tabel yang ingin dijoin mempunyai kolom yang diawali dengan nama_tabel (contoh: nama_kontak)</li>
                            <li>Untuk upload gambar, masukan kolom yang akan dijadikan kolom upload gambar / file</li>
                            <li>Untuk join tabel, pastikan kolom primary key dan foreign key haruslah sama</li>
                ...
                <script type="text/javascript">
                    $('.join_table').click(function(e) {
                        e.preventDefault();
                        $.get(base_url + 'crud_generator/get_table', function(data) {
                            arr = JSON.parse(data)
